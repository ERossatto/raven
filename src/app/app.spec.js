const simpleDataJson = require('./dataset/simple-data.json');
const dataForBugJson = require('./dataset/data-for-bug.json');
const createFileTree = require('./app');
...
describe('fileTree', function () {
  ...
  function testTreeContentsWithDataSet(dataSet) {
    describe('created from dataSet', function() {
  ...
  testTreeContentsWithDataSet(simpleDataJson);
  testTreeContentsWithDataSet(dataForBugJson);
